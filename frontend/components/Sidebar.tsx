...
const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView, user, onLogout }) => {
  const menuItems: { name: View; icon: React.ReactNode; allowedRoles: string[] }[] = [
    { name: 'Dashboard', icon: ICONS.Dashboard, allowedRoles: ['Admin', 'Coach', 'Student'] },
    { 
        name: 'Students', 
        icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>,
        allowedRoles: ['Admin', 'Coach', 'Student'] 
    },
    { name: 'Attendance', icon: ICONS.Attendance, allowedRoles: ['Admin', 'Coach', 'Student'] },
    { name: 'Performance', icon: ICONS.Performance, allowedRoles: ['Admin', 'Coach', 'Student'] },
    { name: 'Schedule', icon: ICONS.Schedule, allowedRoles: ['Admin', 'Coach', 'Student'] },
    { name: 'VideoAI', icon: ICONS.VideoAI, allowedRoles: ['Admin', 'Coach', 'Student'] },
    { name: 'Chat', icon: ICONS.Chat, allowedRoles: ['Admin', 'Coach', 'Student'] },
    { 
      name: 'Staff', 
